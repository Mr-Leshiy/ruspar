<?
$alttext   = 'Общественная баня &laquo;РУССКИЙ ПАР&raquo;' ;
$titletext = 'Общественная баня &laquo;РУССКИЙ ПАР&raquo;, Одесса' ;
?>
<html>
<? include ("meta.inc"); ?>
<title><? echo $TitleGlobal; ?>Баня ДОБРЫНЯ</title>
...
<h1>Баня ДОБРЫНЯ</h1>
<br>
<img src="http://www.dobrynja.od.ua/images/dobr_price_31.jpg" alt="Баня ДОБРЫНЯ" title="Баня Добрыня">
<br>
<img src="http://www.dobrynja.od.ua/images/dobr_price_32.jpg" alt="Баня ДОБРЫНЯ" title="Баня Добрыня">
<br>
</center>
