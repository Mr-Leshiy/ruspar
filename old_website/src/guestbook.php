...
<head>
<? include ("meta.inc"); ?>
<title><? echo $TitleGlobal; ?> Книга отзывов</title>
</head>
...
<h1 style="text-shadow: 1px 1px 2px BLACK, 0 0 1em YELLOW, 0 0 0.2em ORANGE; color: RED;">Система добавления отзывов временно отключена</h1>

<!--
<h2>Вы можете отправить нам свой отзыв:</h2>
...
<table width="75%" style='border:1px solid #C16719' bgcolor="#FFFED8" cellspacing="0" border="0" cellpadding="5">
 ...
 <tr>
  <td align="center">
   <font color="#FF0000"><b>*</b></font> - все поля обязательны для заполнения!
  </td>
 </tr>
